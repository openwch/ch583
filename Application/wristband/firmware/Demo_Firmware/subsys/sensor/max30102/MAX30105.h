...
class MAX30105 {
 public: 
  ...
  bool begin(TwoWire &wirePort = Wire, uint32_t i2cSpeed = I2C_SPEED_STANDARD, uint8_t i2caddr = MAX30105_ADDRESS);
...
int test_MAX30102_SPO2(void);
void test_MAX30102_HeartRate(void);
