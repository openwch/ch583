...
static uint8 scanRspData[] = {
        ...
        GAP_ADTYPE_LOCAL_NAME_COMPLETE, 'W', 'C', 'H', ' ', 'W', 'r', 'i', 's', 't',
        'b', 'a', 'n', 'd',
...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "WCH Wristband";

// Connection item list
peripheralConnItem_t peripheralConnList;

static uint8 peripheralMTU = ATT_MTU_SIZE;
/*********************************************************************
 * LOCAL FUNCTIONS
 */
...
//    }
    ...
    // Setup the SimpleProfile Characteristic Values
    {
        ...
        SIMPLEPROFILE_CHAR3_LEN, charValue3);
...
static void Peripheral_LinkEstablished(gapRoleEvent_t * pEvent) {
    ...
    if (peripheralConnList.connHandle != GAP_CONNHANDLE_INIT) {
        ...
        tmos_start_task(Peripheral_TaskID, SBP_PHY_UPDATE_EVT,
        SBP_PHY_UPDATE_DELAY);
