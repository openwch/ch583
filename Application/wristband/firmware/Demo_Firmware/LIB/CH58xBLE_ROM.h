...
#define LIB_FLASH_MAX_SIZE        0x00020000

#define RAM_BASE_ADDRESSS         0x20002000
#define UUID_BASE_ADDRESSS        0x00010008
 ...
 * PUBLIC FUNCTIONS
 */
#define    tmos_rand    ((  u32  (*)  ( void  ))  BLE_LIB_JT(1)) // pseudo-random number
#define    tmos_memcmp  ((  BOOL (*)  ( const void *src1, const void *src2, u32 len ))  BLE_LIB_JT(2))  // TRUE - same, FALSE - different
#define    tmos_isbufset (( BOOL (*)  ( u8 *buf, u8 val, u32 len ))  BLE_LIB_JT(3)) // TRUE if all "val",FALSE otherwise
 ...
 * @return      TRUE - success.
 */
#define    tmos_start_task  ((  bStatus_t  (*)  ( tmosTaskID taskID, tmosEvents event, tmosTimer time  ))  BLE_LIB_JT(9))
 ...
 */
#define    TMOS_TimerInit  ((  bStatus_t (*)  ( pfnGetSysClock fnGetClock ))  BLE_LIB_JT(16))
 ...
 * @return      None.
 */
#define    LL_ConnectEventRegister  ((  void  (*)  ( pfnConnectEventCB connectEventCB ))  BLE_LIB_JT(26))
 ...
 * @return  Success or Failure
 */
#define     GATTServApp_ProcessCCCWriteReq  ((  bStatus_t  (*)  ( uint16 connHandle, gattAttribute_t *pAttr,\
  uint8 *pValue, uint16 len, uint16 offset,uint16 validCfg ))  BLE_LIB_JT(68) )
 ...
 *
 */
#define   GAPRole_TerminateSync ((  bStatus_t (*) ( uint16 syncHandle ))  BLE_LIB_JT(125) )
 ...
 */
#define     GAPRole_UpdateLink  ((  bStatus_t  (*)  ( uint16 connHandle, uint16 connIntervalMin,\
  uint16 connIntervalMax, uint16 connLatency, uint16 connTimeout ))  BLE_LIB_JT(84) )
 ...
 *          bleIncorrectMode: No connection to update.<BR>
 */
#define   GAPRole_UpdatePHY ((  bStatus_t (*) ( uint16 connHandle, uint8 all_phys, uint8 tx_phys,\
    uint8 rx_phys, uint16 phy_options)) BLE_LIB_JT(122) )
 ...
 */
#define     GAPRole_PeripheralConnParamUpdateReq  ((  bStatus_t  (*)  ( uint16 connHandle, uint16 connIntervalMin,\
    uint16 connIntervalMax,uint16 latency, uint16 connTimeout,uint8 taskId ))  BLE_LIB_JT(93) )
