/********************************** (C) COPYRIGHT *******************************
 * File Name          : ble_iochub_service_same_char.c
 * Author             : WCH
 * Version            : V1.1
 * Date               : 2022/01/19
 * Description        :
...
static CONST gattAttrType_t ble_iochub_Service = {ATT_UUID_SIZE, ble_iochub_ServiceUUID};

// Profile Characteristic 1 Properties
//static uint8_t ble_iochub_RxCharProps = GATT_PROP_WRITE_NO_RSP| GATT_PROP_WRITE;
//static uint8_t ble_iochub_RxCharProps = GATT_PROP_WRITE_NO_RSP;
...
static uint8_t ble_iochub_TxCharProps = GATT_PROP_WRITE_NO_RSP | GATT_PROP_NOTIFY;
...
static gattAttribute_t ble_iochub_ProfileAttrTbl[] = {
    ...
    {
        { ATT_UUID_SIZE, ble_iochub_RxCharUUID },
        GATT_PERMIT_WRITE,
        0,
    ...
    {
        {ATT_UUID_SIZE, ble_iochub_TxCharUUID},
        GATT_PERMIT_WRITE,
        0,
                                      ...
                                      uint8_t *pValue, uint16_t len, uint16_t offset, uint8_t method)
{
    ...
    {
        // 128-bit UUID
        if(pAttr->handle == ble_iochub_ProfileAttrTbl[RAWPASS_TX_VALUE_HANDLE].handle)
        {
