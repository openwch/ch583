 ...
 * @return  none
 */
static void gen_onoff2_status(struct bt_mesh_model *model, struct bt_mesh_msg_ctx *ctx)
{
    NET_BUF_SIMPLE_DEFINE(msg, 32);
    int err;

    bt_mesh_model_msg_init(&msg, BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS);
    net_buf_simple_add_u8(&msg, read_led2_state(MSG2_PIN));
 ...
 * @return  none
 */
static void gen_onoff2_get(struct bt_mesh_model *model, struct bt_mesh_msg_ctx *ctx, struct net_buf_simple *buf)
{
    APP_DBG(" ");

    gen_onoff2_status(model, ctx);
}
 ...
 * @return  none
 */
static void gen_onoff2_set(struct bt_mesh_model *model, struct bt_mesh_msg_ctx *ctx, struct net_buf_simple *buf)
{
    ...
    set_led2_state(MSG2_PIN, buf->data[0]);
 ...
 * @return  none
 */
static void gen_onoff2_set_unack(struct bt_mesh_model *model, struct bt_mesh_msg_ctx *ctx, struct net_buf_simple *buf)
{
    uint8_t status;

    APP_DBG(" ");

    status = read_led2_state(MSG2_PIN);
...
const struct bt_mesh_model_op gen_onoff2_op[] = {
    {BLE_MESH_MODEL_OP_GEN_ONOFF_GET, 0, gen_onoff2_get},
    {BLE_MESH_MODEL_OP_GEN_ONOFF_SET, 2, gen_onoff2_set},
    {BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK, 2, gen_onoff2_set_unack},
