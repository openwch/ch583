...
//AOA获取协议版本
__attribute__((aligned(4)))  const UINT8 GetProtocol[] = { 0xc0, 0x33, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00 };
//启动配件模式
__attribute__((aligned(4)))  const UINT8 TouchAOAMode[] = { 0x40, 0x35, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
/* AOA相关数组定义 */
__attribute__((aligned(4)))  const UINT8 Sendlen[] = { 0, 4, 16, 35, 39, 53, 67 };
//字符串ID,与手机APP相关的字符串信息
__attribute__((aligned(4)))  UINT8 StringID[] = { 'W',
                                               'C',
                                               'H',
...
//应用索引字符串命令
__attribute__((aligned(4)))  const UINT8 SetStringID[] = { 0x40, 0x34, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00, 0x40, 0x34,
